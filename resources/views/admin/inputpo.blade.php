    ...
    <section class="content">
      <div class="row">
       ...
       <form action="?m=siswa&s=simpan" method="post" enctype="multipart/form-data">
          ...
          <tr>
            <td>No*</td>
            <td><input type="text" name="nama"  size="50px" maxlength="50px" required /></td>
          </tr>
           <tr>
            <td>Nama Barang*</td>
          ...
          <tr>
            <td width=174>Total Harga Barang*</td>
            <td><input type="number" name="nis" placeholder="Nomor Induk" size="10px" maxlength="9px" required /><small> INI OTOMATIS</small></td>
          </tr>
          ...
          <tr>
            ...
            <td> <textarea name=" Comment" placeholder=" Pesan Untuk Vendor" size="100% " maxlength="150px"> </textarea></td>
          </tr>
